Install-ChocolateyZipPackage 'elastics' 'http://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-1.4.2.zip' "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"

$path = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)\elasticsearch-1.4.2\bin"
...
[Environment]::SetEnvironmentVariable("ES_START_TYPE", "auto")
[Environment]::SetEnvironmentVariable("ELASTIC_SEARCH_PATH", "$(Split-Path -parent $MyInvocation.MyCommand.Definition)\elasticsearch-1.4.2\", "Machine")
